...
//import org.ceilometer.CeilometerTestAutomationSuite.TestDataDriver;

public class MeterListFilterWithFieldsTest {
  	...
  	for(String authToken:tokensList){
  		List <String>JSONMeterIdValues=ml.getJSONFieldValues(authToken, "/v2/meters", "meter_id");
  		  ...
  		  for(String jsonValue: JSONMeterIdValues){
  			  ...
  			  int num=ml.getMetersStatus(authToken, newResPath);
